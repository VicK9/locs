...
def build_flags():
    ...
    parser.add_argument('--working_dir', default='results/synth/locs_release/seed_1/', type=str)
    parser.add_argument('--gpu', action='store_true')
    parser.add_argument('--seed', type=int, default=1)
    parser.add_argument('--mode', choices=['train', 'eval', 'eval_fixedwindow',
                                           'save_pred'], default='train')
    parser.add_argument('--load_model')
    parser.add_argument('--load_best_model', action='store_true')
    parser.add_argument('--continue_training', action='store_true')
    parser.add_argument('--model_type', default='locs', choices=['locs', 'nri', 'egnn'])
    ...
    parser.add_argument('--decoder_type', default='ref_mlp')

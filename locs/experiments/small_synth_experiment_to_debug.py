...
if __name__ == '__main__':
    parser = build_flags()
    parser.add_argument('--data_path', default='data/synth/')
    ...
    # From the comment which contains the arguments above, pass the arguments to the parser
    # parser.add_argument('--mode', default='train')
    # parser.add_argument('--data_path', default='data/synth/')
    # parser.add_argument('--working_dir', choices=['results/synth/locs_release/seed_1/'], default='results/synth/locs_release/seed_1/')
    parser.add_argument('--mode_type', default='locs')
    # parser.add_argument('--graph_type', default='dynamic')
    ...
    # parser.add_argument('--encoder_mlp_num_layers', type=int, default=3)
    # parser.add_argument('--encoder_mlp_hidden', type=int, default=128)
    # parser.add_argument('--encoder_rnn_hidden', type=int, default=64)
    # parser.add_argument('--decoder_hidden', type=int, default=256)
    # parser.add_argument('--decoder_type','ref_mlp')
    # parser.add_argument('--rnn_hidden', type=int, default=64)
    # parser.add_argument('--use_learned_prior', action='store_true')
    # parser.add_argument('--prior_num_layers', type=int, default=3)
    # parser.add_argument('--prior_hidden_size', type=int, default=128)
    # parser.add_argument('--seed', type=int, default=1)
    parser.add_argument('--vel_norm_norm', action='store_true', default=True)
    # parser.add_argument('--add_uniform_prior', action='store_true')
    # parser.add_argument('--no_edge_prior', type=float, default=0.9)
    # parser.add_argument('--batch_size', type=int, default=16)
    # parser.add_argument('--lr', type=float, default=5e-4)
    # parser.add_argument('--use_adam', action='store_true', default=True)
    # parser.add_argument('--num_epochs', type=int, default=200)
    # parser.add_argument('--lr_decay_factor', type=float, default=0.5)
    # parser.add_argument('--lr_decay_steps', type=int, default=200)
    # parser.add_argument('--normalize_kl', action='store_true', default=True)
    # parser.add_argument('--normalize_nll', action='store_true', default=True)
    # parser.add_argument('--tune_on_nll', action='store_true', default=True)
    # parser.add_argument('--val_teacher_forcing', action='store_true', default=True)
    # parser.add_argument('--teacher_forcing_steps', type=int, default=-1)
